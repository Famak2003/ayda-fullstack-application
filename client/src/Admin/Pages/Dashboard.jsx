...
const Dashboard = () => {
    ...
    return (
        <div id="frank" className=" relative p-2 h-fit w-[100vw] ">
            ...
            <button 
              className={` absolute top-0  group z-[9999] inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600 ${showSidebar ? "translate-x-64" : ""} `}
            ...
            <div className=" flex md:grid md:grid-cols-[25%_75%] lg:grid-cols-[20%_80%] 3xl:grid-cols-[280px_1fr] gap-0 min-h-[100dvh] w-full" >
