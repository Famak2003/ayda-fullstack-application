...
const Greetings = () => {
    ...
    return (
        <div className=" flex justify-center items-center w-full bg-light ring-2 py-5" >
            <div className="grid max-[1150px]:grid-cols-1 grid-cols-2 max-w-[1180px] bg-opacity-50 px-[15px] " >
                ...
                <div className=" flex flex-col justify-center items-center ">
                    <DoubleHeader header1={"AYDA-IVF WEBSITE"} header2={"Welcome"} />
                    ...
                    <DoubleHeader header1={"Ayda IVF Team Director & Embryology Laboratory Manager"} header2={"Tanyel FELEK, MS"} align={"left"} flip={true} />
                </div>
            </div>
        </div>
    )
