...
import { getEggDonorContent } from "../../../../Redux/actions/eggDonorAction"
import { useEffect } from "react"

const EggDonation = () => {
    const data = useSelector(state => state.eggDonor.data)
    const dispatch = useDispatch()
    useEffect(() => {
        dispatch(getEggDonorContent())
    }, [])
    console.log("Public EggDonor ******", data)
    return (
